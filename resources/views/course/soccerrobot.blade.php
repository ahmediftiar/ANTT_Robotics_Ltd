            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8">
                        <!-- Post-->
                        <article class="post">
                            <div class="post-preview"><img src="{{ asset('/assets/images/course/soccerrobot1110x512.jpg') }}" alt="article" class="img-fluid" /></div>
                            <div class="post-wrapper">
                                <div class="post-header">
                                    <h1 class="post-title">Build Your Soccer Robot using Arduino</h1>
                                    <!--<ul class="post-meta">-->
                            ...
                            <h4 class="mt-5 text-primary">What you’ll learn</h4>
                                <div class="d-flex align-items-center mb-3">
                                      ...
                                      <p class="mb-0 ml-3">Robot Design Concept</p>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                      <div class="badge-primary-soft rounded p-1">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                      ...
                                      <p class="mb-0 ml-3">Wireless Communication & Controlling</p>
                                    </div>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                      ...
                                      <p class="mb-0 ml-3">Arduino Hardware Setup & Working</p>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                      <div class="badge-primary-soft rounded p-1">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                      ...
                                      <p class="mb-0 ml-3">Designing Wireless Simple Circuits </p>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                      <div class="badge-primary-soft rounded p-1">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                      ...
                                      <p class="mb-0 ml-3">Developing Soccer Bot</p>
                                    </div>
                                     ...
                                     <h4 class="mt-5 text-primary">Course Details: </h4>
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div class="d-flex align-items-center mt-3">
                                              ...
                                              <p class="mb-0 ml-3">Age Group: 9-16 years</p>
                                            </div>
                                        </div>
                        ...
                        <div class="comments-area mb-5">
                          <div class="comment-respond">
                              ...
                              <a class="btn btn-brand-02" href="{{ route('orderform', ['name'=> 'Build Your Soccer Robot using Arduino', 'category' => 'Course', 'price' => 6000, 'image' => 'https://edublock.co/anttaset/soccerrobot%281110x512%29.jpg']) }}">Enroll Now</a>
                          </div>
                      </div>
                        <!-- Comments area end-->
                    </div>
