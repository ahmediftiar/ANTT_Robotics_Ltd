            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8">
                        <!-- Post-->
                        <article class="post">
                            <div class="post-preview"><img src="https://edublock.co/anttaset/soccerrobot%281110x512%29.jpg" alt="article" class="img-fluid" /></div>
                        ...
                        <div class="comments-area mb-5">
                            <div class="comment-respond">
                                ...
                                <form class="comment-form row" method="get" target="_blank" action="https://digitaldokan.shop/product/build-your-soccer-robot-using-arduino-38178">
