        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <img src="{{ asset('/assets/images/solution/laptop1.png') }}">
                </div>
            ...
            <div class="playbutton">
              <a href="https://www.youtube.com/embed/zRuzBecFq4s" target=”_blank” class="mx-auto"><img src="{{ asset('/assets/images/solution/plybutton.png') }}"> </a>
            </div>
            <div class="space"></div>
            <div class="space"></div>
        </div>
          ...
          <div class="row">
            <div class="col-lg-6 col-12">
              <div class="laptopicon1">
                <ul>
                  <li id="slide1"><img src="{{asset('/assets/images/solution/laptopicon1.png')  }}"></li>                 
                </ul>
              </div><br>
              <div class="slides">
                <a href="#"><img src="{{ asset('/assets/images/solution/icon002.png')  }}"></a>
                <a href="#"><img src="{{ asset('/assets/images/solution/icon001.png')  }}"></a>
                <a href="#"><img src="{{ asset('/assets/images/solution/icon003.png')  }}"></a>
              </div>
            </div>
            <div class="col-lg-6 col-12 text-center">
              ...
              <div class="row" style="height:120px;">
                <div class="col-6 staricon">
                  <img src="{{ asset('/assets/images/solution/Reviewicons.png')  }}">
                </div>
                <div class="col-6">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6 track11" >
              <div class="">
                <ul>
                  <li id=""><img src="{{ asset('/assets/images/solution/image101.png')  }}"></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="col-12">
          ...
          <div class="row sln-icon">
            <div class="col-lg-3 col-6">
              <img src="{{ asset('/assets/images/solution/icon1.png')  }}" class="d-block m-auto pb-2">
              <p class="text-center">Graphical Profile Page & Dashboard</p>
            </div>
            <div class="col-lg-3 col-6">
              <img src="{{ asset('/assets/images/solution/icon2.png')  }}" class="d-block m-auto pb-2">
              <p class="text-center">Gamified Courses & Quizzes</p>
            </div>
            <div class="col-lg-3 col-6">
              <img src="{{ asset('/assets/images/solution/icon3.png')  }}"  class="d-block m-auto pb-2">
              <p class="text-center">Monitoring  Progress & Reports</p>
            </div>
            <div class="col-lg-3 col-6">
              <img src="{{ asset('/assets/images/solution/icon4.png')  }}"  class="d-block m-auto">
          ...
          <div class="col-12 col-lg-6 col-xl-5">
                <div>
                  ...
                  <div class="d-lg-none d-block col-12 col-lg-6 mb-3 mb-lg-0">
                    <img src="{{ asset('/assets/images/solution/icon111.png')  }}" alt="Image" class="img-fluid">
                  </div>
          ...
          <div class="container">
            <div class="row align-items-center justify-content-between">
              <div class="d-lg-block d-none col-12 col-lg-6 mb-3 mb-lg-0">
                <img src="{{ asset('/assets/images/solution/icon222.png')  }}" alt="Image" class="img-fluid">
              </div>
              <div class="col-12 col-lg-6 col-xl-5">
                <div> 
        ...
        <section class="pt-0">
          ...
          <div class="col-12 col-lg-6 col-xl-5">
                <div>
                  ...
                  <div class="d-lg-none d-block col-12 col-lg-6 mb-3 mb-lg-0">
                    <img src="{{ asset('/assets/images/solution/icon333.png')  }}" alt="Image" class="img-fluid">
                  </div>
              ...
              <div class="contect101"> 
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 section06_image">
                    <img src="{{ asset('/assets/images/solution/laptop2.png')  }}">
                  </div>
                  <div class="col-lg-4"></div>
